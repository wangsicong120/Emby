...
wget -P /opt/emby-server/system/dashboard-ui/bower_components/emby-apiclient/ https://raw.githubusercontent.com/wangsicong120/Emby/main/connectionmanager.js
rm -f /opt/emby-server/system/dashboard-ui/embypremiere/embypremiere.js
wget -P /opt/emby-server/system/dashboard-ui/embypremiere/ https://raw.githubusercontent.com/wangsicong120/Emby/main/embypremiere.js
echo "web破解完成..."
